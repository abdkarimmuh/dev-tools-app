...
export const navGroupDescriptions: Record<Language, Record<string, string>> = {
  ...
  id: {
    ...
    Converter:
      "Konverter dua arah antar format dan satuan — JSON↔CSV/XML/YAML, JSON↔Go struct/TypeScript interface, timestamp, dan basis angka.",
    Encoding:
      "Encode dan decode data ke berbagai format — Base64/Base32/Base58/Hex, tabel referensi ASCII, JWT token, dan hash kriptografi.",
    ...
    Generator:
      "Generate konten dan nilai unik — UUID, password, QR code, barcode, data palsu, lorem ipsum, ekspresi cron, dan diagram tree.",
    Cryptography:
      "Enkripsi, dekripsi, dan tanda tangan digital — AES, DES/3DES, RSA, RC4, ECDSA, dan API signing berbasis HMAC.",
    "Frontend / CSS":
      "Generator CSS dan utilitas frontend — gradient, box shadow, cheatsheet HTML entities, konversi px↔rem, dan color converter."
  }
};
